        ...
        <div class="main-content">
            ...
            <div class="topbar">
                <div>
                    ...
                    <p>Administra usuarios, técnicos y administradores del sistema.</p>
                </div>

                <a class="btn-panel" href="${pageContext.request.contextPath}/UsuarioServlet?accion=nuevo">
            ...
            <div class="section-panel">
                ...
                <div class="section-header">
                    ...
                    <p>Cuentas con permisos completos sobre el sistema.</p>
                </div>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><span class="badge"><%= u.getNombreRol() %></span></td>
                        <td><%= u.getCorreo() %></td>
                        <td><%= u.getTelefono() == null ? "-" : u.getTelefono() %></td>
                        <td>
                            <span class="<%= u.getEstado() == 1 ? "estado-activo" : "estado-inactivo" %>">
            ...
            <div class="section-panel">
                ...
                <div class="section-header">
                    <h2>Usuarios</h2>
                    <p>Personas que registran solicitudes o incidencias de soporte.</p>
                </div>
            ...
            <div class="section-panel">
                ...
                <div class="section-header">
                    ...
                    <p>Personal encargado de atender, diagnosticar y resolver tickets.</p>
                </div>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><%= u.getTelefono() == null ? "-" : u.getTelefono() %></td>
                        <td><%= u.getArea() == null ? "-" : u.getArea() %></td>
                        <td><%= u.getEspecialidad() == null ? "-" : u.getEspecialidad() %></td>
                        <td>
                            <span class="<%= u.getEstado() == 1 ? "estado-activo" : "estado-inactivo" %>">
                                <%= u.getEstado() == 1 ? "Activo" : "Inactivo" %>
                            </span>
